...
(
 ...
 CONSTRAINT stamp_submission_pkey PRIMARY KEY ( "id" ),
 CONSTRAINT stamp_submission_submission_id_unique UNIQUE ( submission_id ),
 CONSTRAINT stamp_submission_stamp_player_unique UNIQUE ( stamp_id, player_id ),
 CONSTRAINT stamp_submission_submission_id_fkey FOREIGN KEY ( submission_id ) REFERENCES submission ( "id" ) ON DELETE CASCADE ON UPDATE CASCADE,
 CONSTRAINT stamp_submission_player_id_fkey FOREIGN KEY ( player_id ) REFERENCES player ( "id" ) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(
 ...
 new_request_count integer NOT NULL DEFAULT 0,
 error_count       integer NOT NULL DEFAULT 0,
 avg_serve_time    integer NOT NULL DEFAULT 0,
 max_serve_time    integer NOT NULL DEFAULT 0,
 ua_counts         jsonb NOT NULL DEFAULT '{}',
 CONSTRAINT traffic_agg_pkey PRIMARY KEY ( "id" ),
 CONSTRAINT traffic_agg_day_page_unique UNIQUE ( day, page )
);

CREATE INDEX traffic_agg_day_idx ON traffic_agg ( day );
